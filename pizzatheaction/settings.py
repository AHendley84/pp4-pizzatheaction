"""
Django settings for pizzatheaction project.
...
ROOT_URLCONF = 'pizzatheaction.urls'
...
WSGI_APPLICATION = 'pizzatheaction.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket config
    AWS_STORAGE_BUCKET_NAME = 'pp4-pizzatheaction'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'pizzatheaction@example.com'
else:
