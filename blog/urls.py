...
from . import views
from .views import BlogHomeView, PostDetailView, AddPostView, UpdatePostView, DeletePostView, LikeView, AddCommentView
...
urlpatterns = [
    ...
    path('content/<int:pk>/add_comment/', AddCommentView.as_view(), name='add_comment'),
]
